...
{
    /// <summary>
    /// This script is adapted from CAS_GrabInteractableEditor
    /// </summary>
    [CustomEditor(typeof(CAS_GrabInteractable))]
    internal class CAS_GrabInteractableEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            GUI.enabled = false;
            EditorGUILayout.ObjectField("Script", MonoScript.FromMonoBehaviour((CAS_GrabInteractable)target), typeof(CAS_GrabInteractable), false);
            GUI.enabled = true;
