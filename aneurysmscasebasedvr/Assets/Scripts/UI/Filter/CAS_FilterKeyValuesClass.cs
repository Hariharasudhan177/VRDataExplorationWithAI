...
namespace CAS
{
    public class CAS_FilterKeyValuesClass
    {
        string filterName; 
        ...
        public CAS_FilterKeyValuesClass(string filterName, List<string> stringValues, List<double> doubleValues, bool isString)
        {
