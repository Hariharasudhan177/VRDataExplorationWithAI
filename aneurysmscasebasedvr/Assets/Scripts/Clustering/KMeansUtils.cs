...
public static class KMeans {
    ...
    public static KMeansResults Cluster(Bounds[] items, int clusterCount, int maxIterations, int seed) {
        //In this double array, 1st array is for the keys and the 2nd array is the values 
    ...
    private static int[] InitializeClustering(int numData, int clusterCount, int seed) {
        ...
        //Creating an array of the same length of the data to assign which cluster the point belongs to 
