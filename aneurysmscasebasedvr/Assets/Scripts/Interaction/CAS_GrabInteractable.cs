...
{
    /// <summary>
    /// This script is adapted from XR_GrabInteractable
    ...
    /// Don't think that this is necessary now as everything where shifted to new scripts 
    /// </summary>
    [SelectionBase]
    [DisallowMultipleComponent]
    [RequireComponent(typeof(Rigidbody))]
    public class CAS_GrabInteractable : XRBaseInteractable
    {
        ...
        //Go back to original position on unGrab 
        ...
        //Moving this code to interactor 
        /*void HighlightOnHoverEnter(XRBaseInteractor interactor)
        {
            meshRenderer.material.SetColor("_Color", highlightedColor); 
        }

        void DeHighlightOnHoverExit(XRBaseInteractor interactor)
        {
            meshRenderer.material.SetColor("_Color", defaultColor);
        }*/

        //Moving to CAS_ControlModel to generalize this script 
